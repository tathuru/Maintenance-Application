...
public class VhfEcilTxActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vhf_ecil_tx);

        setTitle("ECIL TX Maintenance");
    ...
    public void dailyClicked (View view){
        ...
        Intent intent = new Intent(getApplicationContext(),VhfTxEcilDailyActivity.class);
