...
public class VhfOteRxActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vhf_ote_rx);

        setTitle("OTE RX Maintenance");
    ...
    public void dailyClicked (View view){
        ...
        Intent intent = new Intent(getApplicationContext(),VhfRxOteDailyActivity.class);
    ...
    public void monthlyClicked (View view){
        ...
        Intent intent = new Intent(getApplicationContext(),VhfRxOteMonthlyActivity.class);
        startActivity(intent);
    ...
    public void halfYearlyClicked (View view){
        ...
        Intent intent = new Intent(getApplicationContext(),VhfRxOteSixActivity.class);
        startActivity(intent);
